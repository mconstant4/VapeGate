...
public class BleConnectionService extends Service {
    ...
    private static final String DEBUG_LOG_TAG = BleConnectionService.class.getSimpleName();
    ...
    private BluetoothGattCallback mBluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            sendBroadcast(generateIntent(gatt.getDevice().getAddress(), GATT_CHARACTERISTIC_READ, characteristic.getValue()));
        }
    ...
    public boolean readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        log("Reading Characteristic (" + characteristic.getUuid() + ")...");
